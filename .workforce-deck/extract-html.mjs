...
const slides=[];
const p={slides:{items:slides,add(){const slide={background:{},shapes:{items:[],add(config){const shape={...config};let text={};Object.defineProperty(shape,'text',{enumerable:true,get(){return text},set(value){text.value=value}});this.items.push(shape);return shape;}},speakerNotes:{textFrame:{setText(t){slide.notes=t}}}};slides.push(slide);return slide;}}};
...
await fs.writeFile('/Users/steven/Projects/simulation/.workforce-deck/html-data.json',JSON.stringify(slides));
